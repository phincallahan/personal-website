...
silent only
cd ~/Code/web-dev/blog
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/scss/home.scss
badd +0 src/views/home.html
badd +0 Gruntfile.js
argglobal
silent! argdel *
argadd src/scss/home.scss
set stal=2
edit src/views/home.html
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 134 - ((42 * winheight(0) + 27) / 54)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
134
